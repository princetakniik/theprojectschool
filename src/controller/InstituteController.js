...
res.status(200).json({msg:`update institute successfully ${req.query.institute_id}`,data:update})
    }catch(err){
        console.log(err);
...
res.status(200).json({msg:`institute delete successfully`,data:updateData})
    }catch(err){
        console.log(err);

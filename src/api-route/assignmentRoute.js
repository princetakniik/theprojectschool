...
module.exports = (app) => {
  ...
  app.get("/subCourseAssignmentById", (req, res) => subCourseAssignmentById(req, res));
  app.get("/subCourseAssignmentByCourseId", (req, res) => subCourseAssignmentByCourseId(req, res));
  app.get("/AssignmentBysubCourseId", (req, res) => AssignmentBysubCourseId(req, res));
//update and delete
